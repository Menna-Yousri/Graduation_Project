...
from rag import get_answer as rag_get_answer
#from panda import  get_pandas_answer
from agent import get_answer as get_agent_answer
import json
import web_farmer
import web_vet
...
def get_smart_answer_farmer(question: str) -> str:
    ...
    if query_type == "pandas":
        ...
        answer = web_farmer.run_web_search(question)
...
def get_smart_answer_vet(question: str) -> str:
    ...
    if query_type == "pandas":
        ...
        answer = web_vet.run_web_search(question)
        return json.dumps({"answer": answer, "type": "WEB"})
